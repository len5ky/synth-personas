...
```bash
npm install -g @len5ky/synth-personas-cli
...
After `npm install -g @len5ky/synth-personas-cli && synth-personas install-skills`, two skills become available in both Claude Code and Codex CLI:
...
.
├── packages/
│   ├── core/                       # @len5ky/synth-personas-core — evaluation engine
│   └── cli/                        # @len5ky/synth-personas-cli — TS CLI
